  ...
  useEffect(() => {
    (async () => {
      ...
      if (cameraPermission.granted !== true) {
        Alert.alert("Error", "Camera. Go to settings and allow camera");
      }

      const mediaLibraryPermission =
        await MediaLibrary.requestPermissionsAsync();
      if (mediaLibraryPermission.granted !== true) {
        Alert.alert("Error", "Media Library. Go to settings and allow media");
      }
    })();
  }, []);
